...
// Memory Limit: 125 MB
// Time Limit:   1000 ms
// Created Time: 2023-03-28 19:55:45 
...
inline void pushup(i64 now) { nownode.sum = (leftson.sum + rightson.sum) % p; }

inline void pushdown(i64 now)
{
...
inline void build(i64 l, i64 r, i64 now)
{
...
inline void add(i64 l, i64 r, i64 now, i64 k)
{
...
inline void mul(i64 l, i64 r, i64 now, i64 k)
{
	if (l <= nownode.l && nownode.r <= r)
	{
...
inline i64 query(i64 l, i64 r, i64 now)
{
	if (l <= nownode.l && nownode.r <= r)
		return nownode.sum;
	pushdown(now);
